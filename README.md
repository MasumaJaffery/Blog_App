...
**Blog App** is about Blogs that provides mechanism to end-users to post a blog, comment and like.
...
Note: We are assuming you have pre-installed ruby, WSL, ubuntu and rails also!
...
```sh
  cd my-folder
git@github.com:MasumaJaffery/Blog_App.git
```
